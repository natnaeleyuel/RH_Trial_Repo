...
import com.jct.renthabesha.core.presentation.ui.screens.components.NavigationCompos
...
fun SettingsScreen(modifier: Modifier = Modifier) {
    Surface() {
        NavigationCompos(
            ...
            title = "Settings",
            screen = Screen(Modifier.fillMaxSize())
        )
    }
}

@Composable
fun Screen(modifier: Modifier = Modifier): @Composable (Modifier) -> Unit {
    Column(
        modifier = Modifier.fillMaxSize()
